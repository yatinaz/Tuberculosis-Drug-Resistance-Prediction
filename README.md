...
| MOXI | 0.9116 ± 0.0246 | 0.9117 ± 0.0121 | 0.9032 ± 0.0293 | **0.9185 ± 0.0208** | Ensemble |
| OFLX | 0.9255 ± 0.0292 | 0.9280 ± 0.0287 | 0.9301 ± 0.0157 | **0.9384 ± 0.0247** | Ensemble |
| KAN | 0.9104 ± 0.0217 | 0.9213 ± 0.0131 | 0.9105 ± 0.0160 | **0.9231 ± 0.0129** | Ensemble |
...
1. **MOXI** (0.9185) — Limited samples, heterogeneous resistance mechanisms
2. **KAN** (0.9231) — Small sample size, overlapping resistance with AMK/CAP
3. **OFLX** (0.9384) — Most severe imbalance (87 susceptible vs 603 resistant)
...
| Figure | Description |
|--------|-------------|
| ![AUROC Heatmap](figures/02_auroc_heatmap.png) | Model × Drug AUROC comparison |
| ![ROC Curves](figures/03_roc_curves_yatin.png) | ROC curves for OFLX, AMK, INH |
| ![Sensitivity-Specificity](figures/04_sensitivity_specificity.png) | Clinical operating point analysis |
| ![Feature Importance](figures/05_feature_importance.png) | Top genomic predictors per drug |
...
```
.
├── tb_pipeline.py              # Main training pipeline
├── generate_visualisations.py  # Visualization script
├── requirements.txt            # Python dependencies
├── X_trainData_1.csv          # Training features (222 genomic variants)
├── Y_trainData_1.csv          # Training labels (10 drugs)
├── X_testData_1.csv           # Test features
├── Y_testData_1_nolabels_*.csv # Test labels per drug
├── results/
│   └── model_results.json     # Trained model results
├── figures/
